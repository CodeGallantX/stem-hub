...
export default function Header() {
  return (
    <section className="flex flex-col items-center justify-center text-center py-40 bg-gradient-to-r from-red-600 via-blue-600 to-green-600 min-h-screen px-4 md:px-8 lg:px-16 xl:px-24 relative overflow-hidden animate-gradient">
